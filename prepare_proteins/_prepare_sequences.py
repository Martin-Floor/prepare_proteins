...
class sequenceModels:
    ...
    def copyModelsFromAlphaFoldCalculation(
        self, af_folder, output_folder, prefix="", return_missing=False, copy_all=False
    ):
        """
    ...
    def mutate_fasta(
        self, model, mut_position=int, wt_res=str, new_res=str, start_position=1
    ):
        """
    ...
    def plotInterProScanFoldDistributions(self, ips, top_n=10):
        ...
        plt.title(
            f"Top {top_n} Most Frequent Folds in InterProScan Search (Excluding '-')"
        )
